...
module.exports = {
  skillName,
  intents,
  defaultResponse: `somebody forgot to provide a good default response.`,
  helpMessage: `${skillName} can answer all your questions! Or you can say exit.`,
  helpReprompt: `What can I help you with?`,
  stopMessage: `Later aligator!`,
  errorMessage: `Sorry, an error occurred.  ${skillName} cannot help you right now`,
  exceptionErrorMessage: `an error occured.  have the developer check the logs for javascript errors, and to do more testing!`
}